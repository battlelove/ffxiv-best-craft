...
manully-input = 手動入力`)}typeof mt=="function"&&mt(on);typeof pt=="function"&&pt(on);typeof vt=="function"&&vt(on);typeof gt=="function"&&gt(on);const gs={style:{"margin-left":"10px"}},hs={class:"box-body"},bs={class:"box-body"},$n=X({__name:"MacroExporter",props:{actions:{}},setup(e){const t=e,{$t:o}=Oe(),a=wn(),i=ke(a.options.exportOptions),d=_(()=>[{label:o("has-notify-auto"),value:"auto"},{label:o("has-notify-true"),value:!0},{label:o("has-notify-false"),value:!1}]),p=_(()=>[{label:o("avg-section"),value:"avg"},{label:o("greedy-section"),value:"greedy"},{label:o("disable-section"),value:"disable"}]),g=_(()=>{const r=[{label:o("no-sound"),value:""},{label:o("random-sound"),value:" <se>"}];for(let v=1;v<=16;v++)r.push({label:` <se.${v}>`,value:` <se.${v}>`});return r}),y=_(()=>{if(i.addNotification!="auto")return i.addNotification;{let r=15;i.hasLock&&r--;const v=Math.ceil(t.actions.length/r);r--;const b=Math.ceil(t.actions.length/r);return v==b}}),u=_(()=>{const r=[];let v=15;y.value&&v--,i.hasLock&&v--,i.sectionMethod=="disable"&&(v=1e9);let b=Math.ceil(t.actions.length/v);const k=Math.ceil(t.actions.length/b);for(let C=0;C<b;C++){let V;switch(i.sectionMethod){case"avg":V=t.actions.slice(C*k,Math.min(t.actions.length,(C+1)*k));break;case"greedy":const S=C*v;V=t.actions.slice(S,Math.min(t.actions.length,S+v));break;case"disable":V=t.actions.slice()}let w=[];i.hasLock&&w.push("/mlock");for(let S of V){S==vn.DaringTouch&&(S=vn.HastyTouch);let m=o(S.replaceAll("_","-"));m.includes(" ")&&(m=`"${m}"`),w.push(`/ac ${m} <wait.${eo(S)+i.waitTimeInc}>`)}y.value&&w.push(`/e ${o("marco-finished",{id:C+1})}${i.notifySound}`),r.push(w)}return r});async function h(r,v){const b=v.join(`\r
`).replaceAll(/\u2068|\u2069/g,"");c(b,o("copied-marco",{id:r+1}))}async function c(r,v){try{if(!fn){let{useClipboard:b}=await Lo(async()=>{const{useClipboard:k}=await import("./_plugin-vue_export-helper-RInzzBDv.js").then(C=>C.bF);return{useClipboard:k}},[]);await b().copy(r)}fe({type:"success",duration:2e3,showClose:!0,message:v})}catch(b){fe({type:"error",duration:2e3,showClose:!0,message:o("copy-failed",{err:String(b)})})}}return(r,v)=>($(),D("div",gs,[H("div",null,[l(n(re),{modelValue:i.hasLock,"onUpdate:modelValue":v[0]||(v[0]=b=>i.hasLock=b),label:n(o)("has-lock")},null,8,["modelValue","label"]),n(pa)?($(),P(n(re),{key:0,modelValue:i.oneclickCopy,"onUpdate:modelValue":v[1]||(v[1]=b=>i.oneclickCopy=b),label:n(o)("oneclick-copy")},null,8,["modelValue","label"])):O("",!0)]),l(n(jn),{"label-width":"auto"},{default:s(()=>[l(n(de),{label:n(o)("has-notify")},{default:s(()=>[l(n(De),{modelValue:i.addNotification,"onUpdate:modelValue":v[2]||(v[2]=b=>i.addNotification=b),options:d.value},null,8,["modelValue","options"])]),_:1},8,["label"]),l(n(de),{label:n(o)("section-method")},{default:s(()=>[l(n(De),{modelValue:i.sectionMethod,"onUpdate:modelValue":v[3]||(v[3]=b=>i.sectionMethod=b),options:p.value},null,8,["modelValue","options"])]),_:1},8,["label"]),y.value?($(),P(n(de),{key:0,label:n(o)("notify-sound")},{default:s(()=>[l(n(Wo),{modelValue:i.notifySound,"onUpdate:modelValue":v[4]||(v[4]=b=>i.notifySound=b),options:g.value,style:{width:"200px"}},null,8,["modelValue","options"])]),_:1},8,["label"])):O("",!0),l(n(de),{label:n(o)("wait-time-inc")},{default:s(()=>[l(n(Sn),{modelValue:i.waitTimeInc,"onUpdate:modelValue":v[5]||(v[5]=b=>i.waitTimeInc=b),"controls-position":"right",min:0,"step-strictly":!0},null,8,["modelValue"])]),_:1},8,["label"])]),_:1}),l(n(ce),{wrap:"",alignment:"flex-start"},{default:s(()=>[($(!0),D(oe,null,Te(u.value,(b,k)=>($(),P(n(Pn),{class:L(i.oneclickCopy?"box-card-oneclick":"box-card"),shadow:"hover",onClick:C=>i.oneclickCopy?h(k,b):void 0},{default:s(()=>[H("code",hs,I(b.join(`
`)),1)]),_:2},1032,["class","onClick"]))),256))]),_:1}),l(n(qn),{id:"divider","content-position":"left"},{default:s(()=>[q(I(n(o)("export-json")),1)]),_:1}),e.actions.length>0?($(),P(n(Pn),{key:0,class:L(i.oneclickCopy?"box-card-oneclick":"box-card"),shadow:"hover",style:{width:"300px"},onClick:v[6]||(v[6]=b=>i.oneclickCopy?c(JSON.stringify(e.actions),n(o)("copied-json")):void 0)},{default:s(()=>[H("code",bs,I(JSON.stringify(e.actions,void 0,4)),1)]),_:1},8,["class"])):O("",!0)]))}});function ht(e){const t=e.options||e;t.fluent=t.fluent||{},t.fluent["zh-CN"]=new J(`has-notify = 添加完成提示
...
dp-solver-empty-text = None of solver is loaded`)}typeof $t=="function"&&$t(En);typeof Ct=="function"&&Ct(En);typeof Et=="function"&&Et(En);const ks=ze(En,[["__scopeId","data-v-18c5b9f4"]]),$s={style:{"min-width":"300px",display:"flex","align-items":"center"}},Vn=X({__name:"DfsSolver",props:{canHq:{type:Boolean}},emits:["runSimpleSolver"],setup(e,{emit:t}){const{$t:o}=Oe(),a=e,i=t,d=4,p=E(!1),g=E(d),y=E(!1),u=E(!1),h=E(!1),c=E("initial"),r=["initial","current"];te(()=>a.canHq,k=>{u.value=!k});function v(k){let C=String(k);return k>d&&(C="⚠️"+C),C}function b(){i("runSimpleSolver",an.DFSSolver,h,k=>(u.value?fs:ds)(k,g.value,y.value),c.value)}return(k,C)=>{const V=ne("i18n");return $(),D(oe,null,[l(n(Gn),{modelValue:p.value,"onUpdate:modelValue":C[0]||(C[0]=w=>p.value=w),title:n(o)("dfs-solver-info-title")},{default:s(()=>[l(V,{path:"dfs-solver-info",tag:"span",class:"solver-info"},{ffxivCraftingAlgo:s(({commandLineTool:w})=>[l(n(hn),{type:"primary",href:"https://github.com/Tnze/ffxiv-crafting-algo",target:"_blank"},{default:s(()=>[q(I(w),1)]),_:2},1024)]),_:1})]),_:1},8,["modelValue","title"]),l(n(ce),{direction:"vertical",alignment:"normal"},{default:s(()=>[H("div",$s,[l(n(po),{style:{flex:"none"}},{default:s(()=>[q(I(n(o)("dfs-max-depth")),1)]),_:1}),l(n(Dl),{modelValue:g.value,"onUpdate:modelValue":C[1]||(C[1]=w=>g.value=w),style:{"margin-left":"30px"},min:1,max:10,"format-tooltip":v,"aria-label":n(o)("dfs-max-depth"),disabled:h.value},null,8,["modelValue","aria-label","disabled"])]),g.value>n(d)?($(),P(n(Xe),{key:0,type:"warning",title:n(o)("dfs-too-depth"),"show-icon":"",closable:!1},null,8,["title"])):O("",!0),l(n(re),{modelValue:u.value,"onUpdate:modelValue":C[2]||(C[2]=w=>u.value=w),label:n(o)("do-not-touch"),disabled:h.value},null,8,["modelValue","label","disabled"]),l(n(re),{modelValue:y.value,"onUpdate:modelValue":C[3]||(C[3]=w=>y.value=w),label:n(o)("specialist"),disabled:h.value},null,8,["modelValue","label","disabled"]),l(n(ce),null,{default:s(()=>[l(n(ae),{type:"primary",onClick:b,loading:h.value},{default:s(()=>[q(I(h.value?n(o)("simple-solver-solving"):n(o)("solver-start")),1)]),_:1},8,["loading"]),l(n(ae),{icon:n(On),circle:"",onClick:C[4]||(C[4]=w=>p.value=!0)},null,8,["icon"]),l(n(De),{modelValue:c.value,"onUpdate:modelValue":C[5]||(C[5]=w=>c.value=w),options:r},{default:s(w=>[q(I(n(o)("from-"+w.item)),1)]),_:1},8,["modelValue"])]),_:1})]),_:1})],64)}}});function Vt(e){const t=e.options||e;t.fluent=t.fluent||{},t.fluent["zh-CN"]=new J(`from-initial = 整体求解
from-current = 追加求解
do-not-touch = 不推品质
dfs-max-depth = 最大深度
solver-start = 开始求解
...
action = 技能
buffs = 增益效果`)}function Ot(e){const t=e.options||e;t.fluent=t.fluent||{},t.fluent["en-US"]=new J(`run-simulations = Run simulations
...
action = Action
buffs = Buffs`)}typeof qt=="function"&&qt(In);typeof Lt=="function"&&Lt(In);typeof Ot=="function"&&Ot(In);const Ns=ze(In,[["__scopeId","data-v-d8f852c7"]]),Rn=X({__name:"MarcoInfo",props:{seq:{},status:{}},setup(e){const t=e,o=_(()=>{const i=t.seq.slots.length;return i<=15?"success":i<=30?"warning":"danger"}),a=_(()=>{const i=t.seq.slots.map(d=>d.action);return{macro:eo(...i),manual:Ko(...i)}});return(i,d)=>($(),P(n(ce),null,{default:s(()=>[l(n(he),{round:"",type:o.value},{default:s(()=>[q(I(i.$t("macro-length-tag",{length:t.seq.slots.length})),1)]),_:1},8,["type"]),l(n(he),{round:"",type:"info"},{default:s(()=>[q(I(i.$t("steps-tag",{steps:t.status.step})),1)]),_:1}),l(n(he),{round:"",type:"info"},{default:s(()=>[q(I(i.$t("macro-duration-tag",{duration:n(gn)(a.value.macro*1e3,0)})),1)]),_:1}),l(n(he),{round:"",type:"info"},{default:s(()=>[q(I(i.$t("manual-duration-tag",{duration:n(gn)(a.value.manual*1e3,1)})),1)]),_:1})]),_:1}))}});function Ft(e){const t=e.options||e;t.fluent=t.fluent||{},t.fluent["zh-CN"]=new J(`macro-length-tag = 宏长度：{ $length }
...
manual-duration-tag = Manual Duration: { $duration }`)}typeof Ft=="function"&&Ft(Rn);typeof Ut=="function"&&Ut(Rn);typeof Dt=="function"&&Dt(Rn);const As={class:"main-page"},Ps={class:"crafting-alerts"},qs={class:"above-panel"},Ls={class:"above-right-panel",style:{overflow:"hidden"}},Kt="solver-list",ln=X({__name:"Designer",props:{recipe:{},recipeId:{},requirements:{},collectableShopRefine:{},item:{},materialQualityFactor:{},isCustomRecipe:{type:Boolean}},async setup(e){let t,o;const a=e,i=wn(),d=Ho(),{$t:p}=Oe(),g=ve(Ba),y=Oo("screen and (max-width: 480px)");te(y,M=>{!M&&f.value=="action-panel"&&(f.value=Kt)});const u=E(),{height:h}=Fo(u),c=E(0),r=_(()=>d.gearsets.find(M=>M.id==c.value)),v=_(()=>(r.value??d.default).value);d.$subscribe((M,F)=>{b()}),te([g,()=>a.isCustomRecipe],([M,F],R)=>{const K=r.value;(K==null||K.id==0||!F&&!K.compatibleJobs.includes(M))&&b()},{immediate:!0});function b(){if(a.isCustomRecipe){c.value=0;return}const M=g.value,F=d.gearsets.find((R,K)=>K!=0&&R.compatibleJobs.includes(M));c.value=F?.id??0}const k=E([]),C=_(()=>Jo(v.value,...k.value));var V=_(()=>{let{required_craftsmanship:M,required_control:F}=a.requirements,{craftsmanship:R,control:K}=C.value,j=[];M>R&&j.push(p("craftsmanship")),F>K&&j.push(p("control"));let pe=j.length;if(pe>0){let U=j[0];return pe>1&&(U=p("and",{a:j[0],b:j[1]})),{title:p("attributes-do-not-meet-the-requirements",{num:pe,attribute:U}),descryption:p("attributes-requirements",{craftsmanship:M,control:F})}}});const w=E(0),S=E(!1),m=E(!1),f=E(Kt);let N=null;te(w,(M,F)=>{M>0?F==0&&(N=setTimeout(()=>{S.value=!0},500)):F>0&&(N&&clearTimeout(N),S.value=!1)});const A=E(0),Y=E({...([t,o]=Uo(()=>nt(C.value,a.recipe)),t=await t,o(),t),quality:A.value});te([a,C,A],async([M,F,R])=>{Y.value={...await nt(F,M.recipe),quality:R}});const Q=ke({slots:[],maxid:0}),G=E();un(Y.value,[]).then(M=>G.value=M),Be(Ra,E(Q));const z=_(()=>Q.slots.map(M=>M.action)),T=_(()=>m.value&&le.slots.length>0?le.slots.map(M=>M.action):Q.slots.map(M=>M.action));function B(M){Q.slots.push(pn({id:Q.maxid++,action:M}))}function x(M){const F=Q.slots.length;Q.slots.splice(0,F,...M.slots),Q.maxid=M.maxid}function ge(M){const F=M.map((R,K)=>({id:K,action:R}));x({slots:F,maxid:F.length})}const le=ke({slots:[],maxid:0}),W=E();te(Y,Z),te(Y,async M=>{G.value=await un(M,z.value)}),te(z,async M=>{G.value=await un(Y.value,M)});const ee=_(()=>m.value&&!S.value&&le.slots.length>0?W.value?.status??G.value?.status??Y.value:G.value?.status??Y.value);async function Z(){try{const M=G.value?.status;if(!M)return;w.value++;const F=z.value.concat(await us(M));let R=[],K=new Map;for(const j of le.slots)K.get(j.action)?.push(j.id)==null&&K.set(j.action,[j.id]);for(const j of F){const pe=K.get(j)?.shift()||le.maxid++;R.push({id:pe,action:j})}le.slots=R,W.value=await un(Y.value,F)}catch{le.slots=[]}finally{w.value--}}async function se(M,F,R){if(R)for(const K in M)B(M[K]);else{const K={slots:M.map((j,pe)=>({action:j,id:pe})),maxid:M.length,itemName:i.content?.item.name};x(K)}}return(M,F)=>($(),D("div",As,[H("div",Ps,[n(V)!=null?($(),P(n(Xe),{key:0,title:n(V).title,description:n(V).descryption,type:"warning","show-icon":"",center:"",closable:!1},null,8,["title","description"])):O("",!0)]),l(Yo,{class:"status-bar",attributes:C.value,status:ee.value,"show-condition":!1,"collectable-shop-refine":e.collectableShopRefine},null,8,["attributes","status","collectable-shop-refine"]),H("div",qs,[n(y)?O("",!0):($(),P(n($e),{key:0,class:"above-left-panel"},{default:s(()=>[l(tt,{onClickedAction:B,job:n(g),status:G.value?.status},null,8,["job","status"])]),_:1})),H("div",Ls,[H("div",{ref_key:"actionQueueElem",ref:u,class:"action-queue"},[l(ka,{job:n(g),list:Q.slots,"onUpdate:list":F[0]||(F[0]=R=>Q.slots=R),"solver-result":le.slots,"preview-solver":m.value,"err-list":G.value?.errors,"loading-solver-result":S.value,clearable:""},null,8,["job","list","solver-result","preview-solver","err-list","loading-solver-result"]),l(Rn,{style:{"margin-left":"9px"},seq:Q,status:ee.value},null,8,["seq","status"])],512),l(n(Qt),{class:"above-tabs",modelValue:f.value,"onUpdate:modelValue":F[5]||(F[5]=R=>f.value=R),"tab-position":"top",style:be(`height: calc(100% - ${n(h)+10}px)`)},{default:s(()=>[n(y)?($(),P(n(ye),{key:0,label:n(p)("action-panel"),name:"action-panel",class:"multi-function-area"},{default:s(()=>[l(tt,{onClickedAction:B,status:G.value?.status},null,8,["status"])]),_:1},8,["label"])):O("",!0),l(n(ye),{label:n(p)("init-quality"),name:"init-quality",class:"multi-function-area"},{default:s(()=>[l(n($e),{style:{flex:"auto","padding-left":"30px"}},{default:s(()=>[l(on,{modelValue:A.value,"onUpdate:modelValue":F[1]||(F[1]=R=>A.value=R),item:e.item,recipe:e.recipe,"recipe-id":e.recipeId,"material-quality-factor":e.materialQualityFactor},null,8,["modelValue","item","recipe","recipe-id","material-quality-factor"])]),_:1})]),_:1},8,["label"]),l(n(ye),{label:n(p)("attributes-enhance"),name:"attributes-enhance",class:"multi-function-area"},{default:s(()=>[l(n($e),{style:{flex:"auto","padding-left":"30px"}},{default:s(()=>[l(Qo,{modelValue:k.value,"onUpdate:modelValue":F[2]||(F[2]=R=>k.value=R),"gearset-id":c.value,"onUpdate:gearsetId":F[3]||(F[3]=R=>c.value=R),job:e.isCustomRecipe?void 0:n(g),attributes:v.value},null,8,["modelValue","gearset-id","job","attributes"])]),_:1})]),_:1},8,["label"]),l(n(ye),{label:n(p)("export-macro"),name:"export-macro",class:"multi-function-area"},{default:s(()=>[l(n($e),{style:{flex:"auto"}},{default:s(()=>[l(ys,{actions:T.value},null,8,["actions"])]),_:1})]),_:1},8,["label"]),l(n(ye),{label:n(p)("import-macro"),name:"import-macro",class:"multi-function-area"},{default:s(()=>[l(n($e),{style:{flex:"auto"}},{default:s(()=>[l(ws,{onOnRecognized:ge})]),_:1})]),_:1},8,["label"]),l(n(ye),{label:n(p)("solvers"),name:"solver-list",class:"multi-function-area"},{default:s(()=>[l(n($e),{style:{flex:"auto"}},{default:s(()=>[l(Vs,{"init-status":Y.value,"current-status":ee.value,"recipe-name":e.item.name,"can-hq":e.item.can_be_hq,onSolverLoad:F[4]||(F[4]=R=>Z()),onSolverResult:se,"collectable-shop-refine":e.collectableShopRefine},null,8,["init-status","current-status","recipe-name","can-hq","collectable-shop-refine"])]),_:1})]),_:1},8,["label"]),l(n(ye),{label:n(p)("analyzer"),name:"analyzer",class:"multi-function-area"},{default:s(()=>[l(n($e),{style:{flex:"auto"}},{default:s(()=>[l(Ns,{"init-status":Y.value,actions:T.value,"collectable-shop-refine":e.collectableShopRefine},null,8,["init-status","actions","collectable-shop-refine"])]),_:1})]),_:1},8,["label"])]),_:1},8,["modelValue","style"])])])]))}});function Ht(e){const t=e.options||e;t.fluent=t.fluent||{},t.fluent["zh-CN"]=new J(`solvers = 求解
export-macro = 导出
import-macro = 导入
...
attributes-requirements = 制作该配方要求：作业精度 ≥ { $craftsmanship } 且 加工精度 ≥ { $control }`)}function Gt(e){const t=e.options||e;t.fluent=t.fluent||{},t.fluent["zh-TW"]=new J(`solvers = 求解
export-macro = 匯出
import-macro = 匯入
...
attributes-requirements = 製作可能条件：{ craftsmanship }{ $craftsmanship}以上 と { control }{ $control }以上`)}typeof Ht=="function"&&Ht(ln);typeof Gt=="function"&&Gt(ln);typeof jt=="function"&&jt(ln);typeof Wt=="function"&&Wt(ln);const Ci=ze(ln,[["__scopeId","data-v-e327a74d"]]);export{Ci as default};
//# sourceMappingURL=Designer-DJFv6IY7.js.map
