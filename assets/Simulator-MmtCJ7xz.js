...
`,[F("strong",`
 ...
 `,[Bn({originalTransition:"background-color .3s var(--n-bezier), box-shadow .3s var(--n-bezier)"})])]),ql=Object.assign(Object.assign({},ve.props),{to:Cn.propTo,bordered:{type:Boolean,default:void 0},clearable:Boolean,clearFilterAfterSelect:{type:Boolean,default:!0},options:{type:Array,default:()=>[]},defaultValue:{type:[String,Number,Array],default:null},keyboard:{type:Boolean,default:!0},value:[String,Number,Array],placeholder:String,menuProps:Object,multiple:Boolean,size:String,menuSize:{type:String},filterable:Boolean,disabled:{type:Boolean,default:void 0},remote:Boolean,loading:Boolean,filter:Function,placement:{type:String,default:"bottom-start"},widthMode:{type:String,default:"trigger"},tag:Boolean,onCreate:Function,fallbackOption:{type:[Function,Boolean],default:void 0},show:{type:Boolean,default:void 0},showArrow:{type:Boolean,default:!0},maxTagCount:[Number,String],ellipsisTagPopoverProps:Object,consistentMenuWidth:{type:Boolean,default:!0},virtualScroll:{type:Boolean,default:!0},labelField:{type:String,default:"label"},valueField:{type:String,default:"value"},childrenField:{type:String,default:"children"},renderLabel:Function,renderOption:Function,renderTag:Function,"onUpdate:value":[Function,Array],inputProps:Object,nodeProps:Function,ignoreComposition:{type:Boolean,default:!0},showOnFocus:Boolean,onUpdateValue:[Function,Array],onBlur:[Function,Array],onClear:[Function,Array],onFocus:[Function,Array],onScroll:[Function,Array],onSearch:[Function,Array],onUpdateShow:[Function,Array],"onUpdate:show":[Function,Array],displayDirective:{type:String,default:"show"},resetMenuOnOptionsChange:{type:Boolean,default:!0},status:String,showCheckmark:{type:Boolean,default:!0},onChange:[Function,Array],items:Array}),Dn=Q({name:"Select",props:ql,slots:Object,setup(e){const{mergedClsPrefixRef:t,mergedBorderedRef:n,namespaceRef:o,inlineThemeDisabled:r}=$e(e),i=ve("Select","-select",Kl,$i,e,t),c=T(e.defaultValue),a=he(e,"value"),d=Wt(a,c),s=T(!1),u=T(""),v=Si(e,["items","options"]),f=T([]),h=T([]),g=M(()=>h.value.concat(f.value).concat(v.value)),b=M(()=>{const{filter:p}=e;if(p)return p;const{labelField:j,valueField:X}=e;return(ue,se)=>{if(!se)return!1;const le=se[j];if(typeof le=="string")return vn(ue,le);const ce=se[X];return typeof ce=="string"?vn(ue,ce):typeof ce=="number"?vn(ue,String(ce)):!1}}),y=M(()=>{if(e.remote)return v.value;{const{value:p}=g,{value:j}=u;return!j.length||!e.filterable?p:Ll(p,b.value,j,e.childrenField)}}),w=M(()=>{const{valueField:p,childrenField:j}=e,X=Fl(p,j);return Ri(y.value,X)}),m=M(()=>Al(g.value,e.valueField,e.childrenField)),O=T(!1),E=Wt(he(e,"show"),O),L=T(null),x=T(null),P=T(null),{localeRef:k}=Zo("Select"),V=M(()=>{var p;return(p=e.placeholder)!==null&&p!==void 0?p:k.value.placeholder}),U=[],re=T(new Map),ie=M(()=>{const{fallbackOption:p}=e;if(p===void 0){const{labelField:j,valueField:X}=e;return ue=>({[j]:String(ue),[X]:ue})}return p===!1?!1:j=>Object.assign(p(j),{value:j})});function R(p){const j=e.remote,{value:X}=re,{value:ue}=m,{value:se}=ie,le=[];return p.forEach(ce=>{if(ue.has(ce))le.push(ue.get(ce));else if(j&&X.has(ce))le.push(X.get(ce));else if(se){const xe=se(ce);xe&&le.push(xe)}}),le}const N=M(()=>{if(e.multiple){const{value:p}=d;return Array.isArray(p)?R(p):[]}return null}),G=M(()=>{const{value:p}=d;return!e.multiple&&!Array.isArray(p)?p===null?null:R([p])[0]||null:null}),te=En(e),{mergedSizeRef:ae,mergedDisabledRef:Y,mergedStatusRef:ne}=te;function Z(p,j){const{onChange:X,"onUpdate:value":ue,onUpdateValue:se}=e,{nTriggerFormChange:le,nTriggerFormInput:ce}=te;X&&be(X,p,j),se&&be(se,p,j),ue&&be(ue,p,j),c.value=p,le(),ce()}function oe(p){const{onBlur:j}=e,{nTriggerFormBlur:X}=te;j&&be(j,p),X()}function z(){const{onClear:p}=e;p&&be(p)}function A(p){const{onFocus:j,showOnFocus:X}=e,{nTriggerFormFocus:ue}=te;j&&be(j,p),ue(),X&&we()}function J(p){const{onSearch:j}=e;j&&be(j,p)}function ye(p){const{onScroll:j}=e;j&&be(j,p)}function ze(){var p;const{remote:j,multiple:X}=e;if(j){const{value:ue}=re;if(X){const{valueField:se}=e;(p=N.value)===null||p===void 0||p.forEach(le=>{ue.set(le[se],le)})}else{const se=G.value;se&&ue.set(se[e.valueField],se)}}}function Te(p){const{onUpdateShow:j,"onUpdate:show":X}=e;j&&be(j,p),X&&be(X,p),O.value=p}function we(){Y.value||(Te(!0),O.value=!0,e.filterable&&Bt())}function Ce(){Te(!1)}function He(){u.value="",h.value=U}const Pe=T(!1);function ht(){e.filterable&&(Pe.value=!0)}function vt(){e.filterable&&(Pe.value=!1,E.value||He())}function gt(){Y.value||(E.value?e.filterable?Bt():Ce():we())}function bt(p){var j,X;!((X=(j=P.value)===null||j===void 0?void 0:j.selfRef)===null||X===void 0)&&X.contains(p.relatedTarget)||(s.value=!1,oe(p),Ce())}function Qe(p){A(p),s.value=!0}function Je(){s.value=!0}function pt(p){var j;!((j=L.value)===null||j===void 0)&&j.$el.contains(p.relatedTarget)||(s.value=!1,oe(p),Ce())}function mt(){var p;(p=L.value)===null||p===void 0||p.focus(),Ce()}function yt(p){var j;E.value&&(!((j=L.value)===null||j===void 0)&&j.$el.contains(Uo(p))||Ce())}function rt(p){if(!Array.isArray(p))return[];if(ie.value)return Array.from(p);{const{remote:j}=e,{value:X}=m;if(j){const{value:ue}=re;return p.filter(se=>X.has(se)||ue.has(se))}else return p.filter(ue=>X.has(ue))}}function et(p){Oe(p.rawNode)}function Oe(p){if(Y.value)return;const{tag:j,remote:X,clearFilterAfterSelect:ue,valueField:se}=e;if(j&&!X){const{value:le}=h,ce=le[0]||null;if(ce){const xe=f.value;xe.length?xe.push(ce):f.value=[ce],h.value=U}}if(X&&re.value.set(p[se],p),e.multiple){const le=rt(d.value),ce=le.findIndex(xe=>xe===p[se]);if(~ce){if(le.splice(ce,1),j&&!X){const xe=_(p[se]);~xe&&(f.value.splice(xe,1),ue&&(u.value=""))}}else le.push(p[se]),ue&&(u.value="");Z(le,R(le))}else{if(j&&!X){const le=_(p[se]);~le?f.value=[f.value[le]]:f.value=U}_t(),Ce(),Z(p[se],p)}}function _(p){return f.value.findIndex(X=>X[e.valueField]===p)}function H(p){E.value||we();const{value:j}=p.target;u.value=j;const{tag:X,remote:ue}=e;if(J(j),X&&!ue){if(!j){h.value=U;return}const{onCreate:se}=e,le=se?se(j):{[e.labelField]:j,[e.valueField]:j},{valueField:ce,labelField:xe}=e;v.value.some(Ve=>Ve[ce]===le[ce]||Ve[xe]===le[xe])||f.value.some(Ve=>Ve[ce]===le[ce]||Ve[xe]===le[xe])?h.value=U:h.value=[le]}}function me(p){p.stopPropagation();const{multiple:j}=e;!j&&e.filterable&&Ce(),z(),j?Z([],[]):Z(null,null)}function on(p){!St(p,"action")&&!St(p,"empty")&&!St(p,"header")&&p.preventDefault()}function rn(p){ye(p)}function Tt(p){var j,X,ue,se,le;if(!e.keyboard){p.preventDefault();return}switch(p.key){case" ":if(e.filterable)break;p.preventDefault();case"Enter":if(!(!((j=L.value)===null||j===void 0)&&j.isComposing)){if(E.value){const ce=(X=P.value)===null||X===void 0?void 0:X.getPendingTmNode();ce?et(ce):e.filterable||(Ce(),_t())}else if(we(),e.tag&&Pe.value){const ce=h.value[0];if(ce){const xe=ce[e.valueField],{value:Ve}=d;e.multiple&&Array.isArray(Ve)&&Ve.includes(xe)||Oe(ce)}}}p.preventDefault();break;case"ArrowUp":if(p.preventDefault(),e.loading)return;E.value&&((ue=P.value)===null||ue===void 0||ue.prev());break;case"ArrowDown":if(p.preventDefault(),e.loading)return;E.value?(se=P.value)===null||se===void 0||se.next():we();break;case"Escape":E.value&&(gl(p),Ce()),(le=L.value)===null||le===void 0||le.focus();break}}function _t(){var p;(p=L.value)===null||p===void 0||p.focus()}function Bt(){var p;(p=L.value)===null||p===void 0||p.focusInput()}function ln(){var p;E.value&&((p=x.value)===null||p===void 0||p.syncPosition())}ze(),Le(he(e,"options"),ze);const an={focus:()=>{var p;(p=L.value)===null||p===void 0||p.focus()},focusInput:()=>{var p;(p=L.value)===null||p===void 0||p.focusInput()},blur:()=>{var p;(p=L.value)===null||p===void 0||p.blur()},blurInput:()=>{var p;(p=L.value)===null||p===void 0||p.blurInput()}},Mt=M(()=>{const{self:{menuBoxShadow:p}}=i.value;return{"--n-menu-box-shadow":p}}),qe=r?Ee("select",void 0,Mt,e):void 0;return Object.assign(Object.assign({},an),{mergedStatus:ne,mergedClsPrefix:t,mergedBordered:n,namespace:o,treeMate:w,isMounted:Wo(),triggerRef:L,menuRef:P,pattern:u,uncontrolledShow:O,mergedShow:E,adjustedTo:Cn(e),uncontrolledValue:c,mergedValue:d,followerRef:x,localizedPlaceholder:V,selectedOption:G,selectedOptions:N,mergedSize:ae,mergedDisabled:Y,focused:s,activeWithoutMenuOpen:Pe,inlineThemeDisabled:r,onTriggerInputFocus:ht,onTriggerInputBlur:vt,handleTriggerOrMenuResize:ln,handleMenuFocus:Je,handleMenuBlur:pt,handleMenuTabOut:mt,handleTriggerClick:gt,handleToggle:et,handleDeleteOption:Oe,handlePatternInput:H,handleClear:me,handleTriggerBlur:bt,handleTriggerFocus:Qe,handleKeydown:Tt,handleMenuAfterLeave:He,handleMenuClickOutside:yt,handleMenuScroll:rn,handleMenuKeydown:Tt,handleMenuMousedown:on,mergedTheme:i,cssVars:r?void 0:Mt,themeClass:qe?.themeClass,onRender:qe?.onRender})},render(){return l("div",{class:`${this.mergedClsPrefix}-select`},l(wi,null,{default:()=>[l(Ci,null,{default:()=>l(Il,{ref:"triggerRef",inlineThemeDisabled:this.inlineThemeDisabled,status:this.mergedStatus,inputProps:this.inputProps,clsPrefix:this.mergedClsPrefix,showArrow:this.showArrow,maxTagCount:this.maxTagCount,ellipsisTagPopoverProps:this.ellipsisTagPopoverProps,bordered:this.mergedBordered,active:this.activeWithoutMenuOpen||this.mergedShow,pattern:this.pattern,placeholder:this.localizedPlaceholder,selectedOption:this.selectedOption,selectedOptions:this.selectedOptions,multiple:this.multiple,renderTag:this.renderTag,renderLabel:this.renderLabel,filterable:this.filterable,clearable:this.clearable,disabled:this.mergedDisabled,size:this.mergedSize,theme:this.mergedTheme.peers.InternalSelection,labelField:this.labelField,valueField:this.valueField,themeOverrides:this.mergedTheme.peerOverrides.InternalSelection,loading:this.loading,focused:this.focused,onClick:this.handleTriggerClick,onDeleteOption:this.handleDeleteOption,onPatternInput:this.handlePatternInput,onClear:this.handleClear,onBlur:this.handleTriggerBlur,onFocus:this.handleTriggerFocus,onKeydown:this.handleKeydown,onPatternBlur:this.onTriggerInputBlur,onPatternFocus:this.onTriggerInputFocus,onResize:this.handleTriggerOrMenuResize,ignoreComposition:this.ignoreComposition},{arrow:()=>{var e,t;return[(t=(e=this.$slots).arrow)===null||t===void 0?void 0:t.call(e)]}})}),l(ki,{ref:"followerRef",show:this.mergedShow,to:this.adjustedTo,teleportDisabled:this.adjustedTo===Cn.tdkey,containerClass:this.namespace,width:this.consistentMenuWidth?"target":void 0,minWidth:"target",placement:this.placement},{default:()=>l(tt,{name:"fade-in-scale-up-transition",appear:this.isMounted,onAfterLeave:this.handleMenuAfterLeave},{default:()=>{var e,t,n;return this.mergedShow||this.displayDirective==="show"?((e=this.onRender)===null||e===void 0||e.call(this),Ht(l($l,Object.assign({},this.menuProps,{ref:"menuRef",onResize:this.handleTriggerOrMenuResize,inlineThemeDisabled:this.inlineThemeDisabled,virtualScroll:this.consistentMenuWidth&&this.virtualScroll,class:[`${this.mergedClsPrefix}-select-menu`,this.themeClass,(t=this.menuProps)===null||t===void 0?void 0:t.class],clsPrefix:this.mergedClsPrefix,focusable:!0,labelField:this.labelField,valueField:this.valueField,autoPending:!0,nodeProps:this.nodeProps,theme:this.mergedTheme.peers.InternalSelectMenu,themeOverrides:this.mergedTheme.peerOverrides.InternalSelectMenu,treeMate:this.treeMate,multiple:this.multiple,size:this.menuSize,renderOption:this.renderOption,renderLabel:this.renderLabel,value:this.mergedValue,style:[(n=this.menuProps)===null||n===void 0?void 0:n.style,this.cssVars],onToggle:this.handleToggle,onScroll:this.handleMenuScroll,onFocus:this.handleMenuFocus,onBlur:this.handleMenuBlur,onKeydown:this.handleMenuKeydown,onTabOut:this.handleMenuTabOut,onMousedown:this.handleMenuMousedown,show:this.mergedShow,showCheckmark:this.showCheckmark,resetMenuOnOptionsChange:this.resetMenuOnOptionsChange}),{empty:()=>{var o,r;return[(r=(o=this.$slots).empty)===null||r===void 0?void 0:r.call(o)]},header:()=>{var o,r;return[(r=(o=this.$slots).header)===null||r===void 0?void 0:r.call(o)]},action:()=>{var o,r;return[(r=(o=this.$slots).action)===null||r===void 0?void 0:r.call(o)]}}),this.displayDirective==="show"?[[$t,this.mergedShow],[kn,this.handleMenuClickOutside,void 0,{capture:!0}]]:[[kn,this.handleMenuClickOutside,void 0,{capture:!0}]])):null}})})]}))}}),Gl=Ke("n-dialog-provider"),Hn={icon:Function,type:{type:String,default:"default"},title:[String,Function],closable:{type:Boolean,default:!0},negativeText:String,positiveText:String,positiveButtonProps:Object,negativeButtonProps:Object,content:[String,Function],action:Function,showIcon:{type:Boolean,default:!0},loading:Boolean,bordered:Boolean,iconPlacement:String,titleClass:[String,Array],titleStyle:[String,Object],contentClass:[String,Array],contentStyle:[String,Object],actionClass:[String,Array],actionStyle:[String,Object],onPositiveClick:Function,onNegativeClick:Function,onClose:Function,closeFocusable:Boolean},Yl=In(Hn),Xl=D([$("dialog",`
...
`,[Ne("vertical",`
 ...
 `)]),Ma=Object.assign(Object.assign({},ve.props),{processing:Boolean,type:{type:String,default:"line"},gapDegree:Number,gapOffsetDegree:Number,status:{type:String,default:"default"},railColor:[String,Array],railStyle:[String,Array],color:[String,Array,Object],viewBoxWidth:{type:Number,default:100},strokeWidth:{type:Number,default:7},percentage:[Number,Array],unit:{type:String,default:"%"},showIndicator:{type:Boolean,default:!0},indicatorPosition:{type:String,default:"outside"},indicatorPlacement:{type:String,default:"outside"},indicatorTextColor:String,circleGap:{type:Number,default:1},height:Number,borderRadius:[String,Number],fillBorderRadius:[String,Number],offsetDegree:Number}),pn=Q({name:"Progress",props:Ma,setup(e){const t=M(()=>e.indicatorPlacement||e.indicatorPosition),n=M(()=>{if(e.gapDegree||e.gapDegree===0)return e.gapDegree;if(e.type==="dashboard")return 75}),{mergedClsPrefixRef:o,inlineThemeDisabled:r}=$e(e),i=ve("Progress","-progress",Ba,Gi,e,o),c=M(()=>{const{status:d}=e,{common:{cubicBezierEaseInOut:s},self:{fontSize:u,fontSizeCircle:v,railColor:f,railHeight:h,iconSizeCircle:g,iconSizeLine:b,textColorCircle:y,textColorLineInner:w,textColorLineOuter:m,lineBgProcessing:O,fontWeightCircle:E,[q("iconColor",d)]:L,[q("fillColor",d)]:x}}=i.value;return{"--n-bezier":s,"--n-fill-color":x,"--n-font-size":u,"--n-font-size-circle":v,"--n-font-weight-circle":E,"--n-icon-color":L,"--n-icon-size-circle":g,"--n-icon-size-line":b,"--n-line-bg-processing":O,"--n-rail-color":f,"--n-rail-height":h,"--n-text-color-circle":y,"--n-text-color-line-inner":w,"--n-text-color-line-outer":m}}),a=r?Ee("progress",M(()=>e.status[0]),c,e):void 0;return{mergedClsPrefix:o,mergedIndicatorPlacement:t,gapDeg:n,cssVars:r?void 0:c,themeClass:a?.themeClass,onRender:a?.onRender}},render(){const{type:e,cssVars:t,indicatorTextColor:n,showIndicator:o,status:r,railColor:i,railStyle:c,color:a,percentage:d,viewBoxWidth:s,strokeWidth:u,mergedIndicatorPlacement:v,unit:f,borderRadius:h,fillBorderRadius:g,height:b,processing:y,circleGap:w,mergedClsPrefix:m,gapDeg:O,gapOffsetDegree:E,themeClass:L,$slots:x,onRender:P}=this;return P?.(),l("div",{class:[L,`${m}-progress`,`${m}-progress--${e}`,`${m}-progress--${r}`],style:t,"aria-valuemax":100,"aria-valuemin":0,"aria-valuenow":d,role:e==="circle"||e==="line"||e==="dashboard"?"progressbar":"none"},e==="circle"||e==="dashboard"?l(Pa,{clsPrefix:m,status:r,showIndicator:o,indicatorTextColor:n,railColor:i,fillColor:a,railStyle:c,offsetDegree:this.offsetDegree,percentage:d,viewBoxWidth:s,strokeWidth:u,gapDegree:O===void 0?e==="dashboard"?75:0:O,gapOffsetDegree:E,unit:f},x):e==="line"?l(Ta,{clsPrefix:m,status:r,showIndicator:o,indicatorTextColor:n,railColor:i,fillColor:a,railStyle:c,percentage:d,processing:y,indicatorPlacement:v,unit:f,fillBorderRadius:g,railBorderRadius:h,height:b},x):e==="multiple-circle"?l(_a,{clsPrefix:m,strokeWidth:u,railColor:i,fillColor:a,railStyle:c,viewBoxWidth:s,percentage:d,showIndicator:o,circleGap:w},x):null)}}),Ia=$("switch",`
 height: var(--n-height);
...
//# sourceMappingURL=Simulator-MmtCJ7xz.js.map
