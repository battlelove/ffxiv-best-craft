...
check-update = 检查更新
checking-update = 正在检查更新`)}function q(r){const i=r.options||r;i.fluent=i.fluent||{},i.fluent["zh-TW"]=new z(`# language =
theme = 主題
light = 亮
dark = 暗
auto = 自動
...
check-update = 檢查更新
checking-update = 正在檢查更新`)}function j(r){const i=r.options||r;i.fluent=i.fluent||{},i.fluent["en-US"]=new z(`language = Language
theme = Theme
light = Light
dark = Dark
auto = Auto
...
checking-update = 更新をチェックしています`)}typeof F=="function"&&F(k);typeof q=="function"&&q(k);typeof j=="function"&&j(k);typeof P=="function"&&P(k);const Ne=de(k,[["__scopeId","data-v-25049750"]]);export{Ne as default};
//# sourceMappingURL=Settings-Cl7oqDYW.js.map
