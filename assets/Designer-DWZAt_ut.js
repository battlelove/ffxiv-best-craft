...
`).replaceAll(/\u2068|\u2069/g,"");c(b,o("copied-marco",{id:r+1}))}async function c(r,v){try{if(!fn){let{useClipboard:b}=await Lo(async()=>{const{useClipboard:k}=await import("./_plugin-vue_export-helper-BFa5o2E7.js").then(C=>C.bF);return{useClipboard:k}},[]);await b().copy(r)}fe({type:"success",duration:2e3,showClose:!0,message:v})}catch(b){fe({type:"error",duration:2e3,showClose:!0,message:o("copy-failed",{err:String(b)})})}}return(r,v)=>($(),D("div",gs,[G("div",null,[l(n(re),{modelValue:i.hasLock,"onUpdate:modelValue":v[0]||(v[0]=b=>i.hasLock=b),label:n(o)("has-lock")},null,8,["modelValue","label"]),n(pa)?($(),P(n(re),{key:0,modelValue:i.oneclickCopy,"onUpdate:modelValue":v[1]||(v[1]=b=>i.oneclickCopy=b),label:n(o)("oneclick-copy")},null,8,["modelValue","label"])):F("",!0)]),l(n(jn),{"label-width":"auto"},{default:s(()=>[l(n(de),{label:n(o)("has-notify")},{default:s(()=>[l(n(De),{modelValue:i.addNotification,"onUpdate:modelValue":v[2]||(v[2]=b=>i.addNotification=b),options:d.value},null,8,["modelValue","options"])]),_:1},8,["label"]),l(n(de),{label:n(o)("section-method")},{default:s(()=>[l(n(De),{modelValue:i.sectionMethod,"onUpdate:modelValue":v[3]||(v[3]=b=>i.sectionMethod=b),options:p.value},null,8,["modelValue","options"])]),_:1},8,["label"]),y.value?($(),P(n(de),{key:0,label:n(o)("notify-sound")},{default:s(()=>[l(n(Wo),{modelValue:i.notifySound,"onUpdate:modelValue":v[4]||(v[4]=b=>i.notifySound=b),options:g.value,style:{width:"200px"}},null,8,["modelValue","options"])]),_:1},8,["label"])):F("",!0),l(n(de),{label:n(o)("wait-time-inc")},{default:s(()=>[l(n(Sn),{modelValue:i.waitTimeInc,"onUpdate:modelValue":v[5]||(v[5]=b=>i.waitTimeInc=b),"controls-position":"right",min:0,"step-strictly":!0},null,8,["modelValue"])]),_:1},8,["label"])]),_:1}),l(n(ce),{wrap:"",alignment:"flex-start"},{default:s(()=>[($(!0),D(oe,null,Te(u.value,(b,k)=>($(),P(n(Pn),{class:L(i.oneclickCopy?"box-card-oneclick":"box-card"),shadow:"hover",onClick:C=>i.oneclickCopy?h(k,b):void 0},{default:s(()=>[G("code",hs,I(b.join(`
...
//# sourceMappingURL=Designer-DWZAt_ut.js.map
